...
# The human-in-the-loop process in agentic AI
...
- If the frontend doesn't pass a `thread_id`, that means this is the beginning of a new graph execution.
...
# Wait, why can't I just treat the user approval as a fresh graph execution instead?
...
# I don't use LangGraph. How do I go about doing this?

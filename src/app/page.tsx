  ...
  return (
    <>
      ...
      <div className="space-y-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-3">Professional Experience</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold mt-6 mb-3">Technical Expertise</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold mt-6 mb-3">Education & Achievements</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold mt-6 mb-3">Personal Interests</h2>
        <p>
